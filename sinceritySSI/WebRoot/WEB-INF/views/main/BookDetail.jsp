    ...
    <table align="center" width=90%>
  		...
  		<td>
  			<table border="1" width=100%>        			
       			...
       			<td colspan=2 align=center style="color:red">${book.bname}</td></tr>
       			<tr><td>商品价格</td><td>${book.price}</td></tr>
       			<tr><td>出版社</td><td>${book.press}</td></tr>
       			<tr><td height=300 colspan=3>${book.outline}</td></tr>
       			<tr><td colspan=3 align=center>
       			<a href="<%=basePath%>user/addshopcar.do?isbn=${book.isbn}">加入购物车</a> &nbsp; 
       			<a href="<%=basePath%>book/main.do">返回</a></td></tr>	
    		</table>
