...
<html>
  ...
  <body>
    <table align="center" width=90%>
      ...
      <tr>
      	<td>
      	   <form action="<%=basePath%>back/buyrecord.do" method="post">
      		<table>
      	...
      	<td colspan=8>
      		<table id="tblTurnPage" cellSpacing="0" cellPadding="1" width="100%" border="0" style="font-family:arial;color:red;font-size:12px;">	    		
	    			<tr>
	    				...
	    				<td><a href="<%=basePath%>back/buyrecord.do?page=1&uname=${uname}&beginDate=${beginDate}&endDate=${endDate}">首页|</a>
	    				    <a href="<%=basePath%>back/buyrecord.do?page=${CurrentPageNo-1}&uname=${uname}&beginDate=${beginDate}&endDate=${endDate}">《前页|</a>
	    				    <a href="<%=basePath%>back/buyrecord.do?page=${CurrentPageNo+1}&uname=${uname}&beginDate=${beginDate}&endDate=${endDate}">后页》|</a>
	    				    <a href="<%=basePath%>back/buyrecord.do?page=${maxPageNo}&uname=${uname}&beginDate=${beginDate}&endDate=${endDate}">末页|</a></td>
