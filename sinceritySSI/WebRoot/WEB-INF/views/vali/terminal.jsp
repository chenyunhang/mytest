...
<html>
  ...
  <base href="<%=basePath%>">
    ...
    <script type="text/javascript" src="<%=basePath%>/js/validate/additional-methods.js"></script>
    <script type="text/javascript" src="<%=basePath%>/js/validate/jquery.validate.extend.js"></script>
